...
VIEWS = 40
RESOLUTION = 800
RESULTS_PATH = 'coffeecup_final'
DEPTH_SCALE = 0.22# 0.1
COLOR_DEPTH = 8
FORMAT = 'PNG'
RANDOM_VIEWS = True
UPPER_VIEWS = True
...
if not DEBUG:
    ...
    if FORMAT == 'OPEN_EXR':
      ...
      links.new(map.outputs[0], set_alpha_node.inputs['Image'])
      links.new(set_alpha_node.outputs['Image'], invert.inputs[1])
