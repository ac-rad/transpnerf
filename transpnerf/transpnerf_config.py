...
from transpnerf.transpnerf_dataparser_nerfstudio import TranspNerfNerfstudioDataParserConfig
    ...
    config=TrainerConfig(
        ...
        pipeline=VanillaPipelineConfig(
            datamanager=TranspNerfDataManagerConfig( 
                ...
                dataparser= TranspNerfNerfstudioDataParserConfig(), #TranspNerfDataParserBlenderConfig(), #TranspNerfNerfstudioDataParserConfig(), # #, # TranspNerfNerfstudioDataParserConfig(), #
