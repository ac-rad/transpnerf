...
@dataclass
class TranspNerfNerfstudioDataParserConfig(DataParserConfig):
    """Nerfstudio dataset config"""

    _target: Type = field(default_factory=lambda: TranspNerfNerfstudio)
...
@dataclass
class TranspNerfNerfstudio(DataParser):
